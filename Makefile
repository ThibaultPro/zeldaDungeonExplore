...
DIST          = ../../../Qt/5.15.0/gcc_64/mkspecs/features/spec_pre.prf \
		...
		zDE.pro controller.h \
		dungeongenerator.h \
		gameview.h \
		levelscene.h \
		pixmapitem.h \
		player.h controller.cpp \
		dungeongenerator.cpp \
		gameview.cpp \
		levelscene.cpp \
		main.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents controller.h dungeongenerator.h gameview.h levelscene.h pixmapitem.h player.h $(DISTDIR)/
	$(COPY_FILE) --parents controller.cpp dungeongenerator.cpp gameview.cpp levelscene.cpp main.cpp pixmapitem.cpp player.cpp $(DISTDIR)/
